...
template<typename RandomIt, typename Compare>
void dual_pivot_introsort_impl(RandomIt first, RandomIt last, Compare comp, int depth_limit) {
...
void dual_pivot_introsort(RandomIt first, RandomIt last, Compare comp = Compare{}) {
...
template<typename RandomIt, typename Compare = std::less<>>
void dual_pivot_nth_element(RandomIt first, RandomIt nth, RandomIt last, Compare comp = Compare{}) {
