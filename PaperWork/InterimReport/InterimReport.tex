...
\bibitem{b1} V. Yaroslavskiy, "Dual-Pivot Quicksort," Research Disclosure, 2009.
\bibitem{b2} S. Wild, "Quicksort is Optimal on Chips," \textit{Proceedings of the 2012 ACM-SIAM Symposium on Discrete Algorithms}, 2012.
\bibitem{b3} M. Aumüller and M. Dietzfelbinger, "Optimal Partitioning for Dual-Pivot Quicksort," \textit{ACM Transactions on Algorithms}, 2015.
\bibitem{b4} D. Musser, "Introspective Sorting and Selection Algorithms," \textit{Software: Practice and Experience}, 1997.
\bibitem{b5} W. A. Wulf and S. A. McKee, "Hitting the Memory Wall: Implications of the Obvious," \textit{ACM SIGARCH Computer Architecture News}, 1995.
\bibitem{b6} O. Peters, "Pattern-Defeating Quicksort," \textit{arXiv preprint arXiv:2106.05123}, 2021.
\bibitem{b7} M. Voss, "Demystifying Intel Threading Building Blocks," \textit{IEEE Software}, 2009.
\end{thebibliography}
