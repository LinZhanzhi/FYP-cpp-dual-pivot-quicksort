...
TEMP_OUTPUT_WSL = "/home/lzz725/FYP/benchmarks/temp_result.csv"
# Output file path accessible from Windows
TEMP_OUTPUT_WIN = r"\\wsl$\Ubuntu\home\lzz725\FYP\benchmarks\temp_result.csv"
...
def main():
    ...
    # Write results
    output_csv = r"\\wsl$\Ubuntu\home\lzz725\FYP\benchmarks\sample_size_analysis.csv"
